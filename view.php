...
<html lang="en">
    <head>
        ...
        <title>Detail Pesanan - Toko Gama Komputer</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">Toko Gama Komputer</a>
            <!-- Sidebar Toggle-->
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Selamat datang di website Manajemen Stok Barang dan Penjualan Toko Gama Komputer</li>
                        </ol>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; M. Syukri 2024</div>
                        </div>
                    </div>
                </footer>
            </div>
